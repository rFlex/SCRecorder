...
@objc public class SCPlayerMetalView: MTKView {

    @objc public enum Rotation: Int {
        case rotate0Degrees
    ...
    @objc public var mirroring = false {
        didSet {
            syncQueue.sync {
    ...
    @objc public var rotation: Rotation = .rotate0Degrees {
        didSet {
            syncQueue.sync {
