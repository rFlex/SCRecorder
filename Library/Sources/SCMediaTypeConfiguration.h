...
- (NSDictionary *__nonnull)createAssetWriterOptionsUsingSampleBuffer:(CMSampleBufferRef __nullable)sampleBuffer usingOutput:(AVCaptureVideoDataOutput *__nullable)output;
