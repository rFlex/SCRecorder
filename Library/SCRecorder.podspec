#
#  Be sure to run `pod spec lint SCRecorder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Simon CORSIN" => "simon@corsin.me", "other author" => "email@address.com" }
  # s.author           = 'Simon CORSIN', 'other author'
  # s.social_media_url = "http://twitter.com/Simon CORSIN"
  ...
  s.source       = { :git => "https://github.com/rFlex/SCRecorder.git", :tag => "0.0.1" }
